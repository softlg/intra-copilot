export const translations = {
  zh: {
    ...
    toolResult: "工具返回",
    toolTrace: "执行过程",
    toolTraceGroupCount: (count: number) => `${count} 个大步骤`,
    toolTraceOperationCount: (count: number) => `${count} 项操作`,
    toolTraceRunning: "进行中",
    toolTraceNeedsAttention: "需处理",
    toolTraceDone: "已完成",
    toolTraceGroupAgent: "系统 Agent 协作",
    toolTraceGroupObserve: "页面观察",
    toolTraceGroupAction: "页面操作",
    toolTraceGroupVerify: "结果验证",
    toolTraceGroupOther: "其他处理",
    toolTraceOutput: "执行结果",
    toolTraceGoal: "目标",
    toolTraceTechnical: "技术详情",
    toolTraceInput: "输入：\n",
    toolTraceRawOutput: "输出：\n",
    toolTraceRunningDetail: "正在等待该步骤返回结果。",
    toolTraceSuccessDetail: "该步骤已执行完成。",
    toolTraceStepLimit: "系统 Agent 未在限定步骤内完成，已停止继续执行。",
    toolTracePolicyBlocked: "当前权限策略不允许执行该动作。",
    toolTraceInvalidTarget: "页面元素引用无效，需要重新观察页面。",
    toolTraceTimeout: "操作等待超时，请刷新页面后重试。",
    toolTraceIncompleteTitle: "本次执行未完成",
    toolTraceIncompleteHint:
      "页面操作没有成功，具体失败原因已整理到下方执行过程。",
    toolTraceShowModelResponse: "查看模型完整说明",
    toolTraceHideModelResponse: "收起模型完整说明",
    ...
    browserActionFocus: "定位页面控件",
    browserActionClear: "清空输入内容",
    browserActionSelect: "选择页面选项",
    browserActionCheck: "勾选页面选项",
    browserActionUncheck: "取消勾选",
    browserActionHover: "悬停页面元素",
    browserActionScroll: "滚动页面",
    browserActionPressKey: "发送键盘按键",
    browserActionUpload: "上传文件",
    browserActionNavigate: "打开网页",
    browserActionWait: "等待页面更新",
    browserActionVerify: "验证页面结果",
    browserActionExtract: "读取页面内容",
    browserActionSnapshot: "读取页面状态",
    toolArgs: "参数",
    toolOk: "成功",
    toolFail: "失败",
  ...
  en: {
    ...
    toolTraceGroupCount: (count: number) => `${count} major steps`,
    toolTraceOperationCount: (count: number) =>
      `${count} operation${count === 1 ? "" : "s"}`,
    toolTraceRunning: "Running",
    toolTraceNeedsAttention: "Needs attention",
    toolTraceDone: "Completed",
    toolTraceGroupAgent: "System Agent collaboration",
    toolTraceGroupObserve: "Page observation",
    toolTraceGroupAction: "Page actions",
    toolTraceGroupVerify: "Result verification",
    toolTraceGroupOther: "Other processing",
    toolTraceOutput: "Result",
    toolTraceGoal: "Goal",
    toolTraceTechnical: "Technical details",
    toolTraceInput: "Input:\n",
    toolTraceRawOutput: "Output:\n",
    toolTraceRunningDetail: "Waiting for this step to return.",
    toolTraceSuccessDetail: "This step completed successfully.",
    toolTraceStepLimit:
      "The system Agent reached its step limit and stopped executing.",
    toolTracePolicyBlocked:
      "The current permission policy does not allow this action.",
    toolTraceInvalidTarget:
      "The page element reference is no longer valid. Observe the page again.",
    toolTraceTimeout: "The operation timed out. Refresh the page and retry.",
    toolTraceIncompleteTitle: "This run did not complete",
    toolTraceIncompleteHint:
      "The page operation failed. Review the execution steps below for the reason.",
    toolTraceShowModelResponse: "Show full model response",
    toolTraceHideModelResponse: "Hide full model response",
    ...
    browserActionFocus: "Focus page control",
    browserActionClear: "Clear input",
    browserActionSelect: "Select page option",
    browserActionCheck: "Check page option",
    browserActionUncheck: "Uncheck option",
    browserActionHover: "Hover page element",
    browserActionScroll: "Scroll page",
    browserActionPressKey: "Send keyboard key",
    browserActionUpload: "Upload file",
    browserActionNavigate: "Open web page",
    browserActionWait: "Wait for page update",
    browserActionVerify: "Verify page result",
    browserActionExtract: "Read page content",
    browserActionSnapshot: "Read page state",
    toolArgs: "Arguments",
    toolOk: "Success",
    toolFail: "Failed",
