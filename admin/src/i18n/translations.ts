...
export const translations = {
  zh: {
    ...
    toolTypeLabel: "类型",
    toolBasicSection: "基本信息",
    toolBasicHint: "设置 Tool 的名称、用途和请求方式。",
    toolRequestSection: "请求配置",
    toolRequestHint: "定义调用地址、超时时间与认证信息。",
    toolSchemaSection: "参数定义",
    toolSchemaSectionHint: "使用 JSON Schema 描述 Tool 的输入参数。",
    toolEnabledHint: "启用后 Agent 才能调用此 Tool。",
    remoteName: "远端名称",
    ...
    skillPublishBeforeEnable: "发布后才能启用",
  ...
  en: {
    ...
    toolTypeLabel: "Type",
    toolBasicSection: "Basic information",
    toolBasicHint: "Set the Tool name, purpose, and request method.",
    toolRequestSection: "Request configuration",
    toolRequestHint: "Define the endpoint, timeout, and authentication.",
    toolSchemaSection: "Parameter definition",
    toolSchemaSectionHint: "Describe the Tool input with JSON Schema.",
    toolEnabledHint: "Agents can call this Tool only when it is enabled.",
    ...
    skillPublishBeforeEnable: "Publish before enabling",
