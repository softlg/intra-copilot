...
export const translations = {
  zh: {
    ...
    mcpDeleteConfirm: (name: string) =>
      `确定删除 MCP 服务“${name}”吗？该服务同步的工具也会删除；仍被 Agent 或 Skill 引用时系统会拒绝。`,
    ...
    hookBindings: "钩子绑定",
    hookBindingsHint: "展示直接指定该 Agent 或按 Agent 角色命中的钩子。",
    noBoundHooks: "该 Agent 暂未绑定钩子。",
    ...
    allAgents: "全部 Agent",
    hookCreated: (name: string) => `钩子 “${name}”已创建`,
    ...
    agentPlanningModeHint:
      "自动模式仅对多步骤、长任务或复杂工具任务生成计划；始终规划模式会在每轮执行前生成计划。",
    ...
    version: "版本",
    skillSearchPlaceholder: "搜索名称、描述、工具或 Agent",
    ...
    skillToolCount: (count: number) => `${count} 个工具`,
    ...
    skillToolsSelected: (selected: number, total: number) =>
      `已选择 ${selected} / ${total} 个工具`,
    skillNoTools: "暂无可绑定工具，请先在工具管理中创建并启用工具。",
    skillSaveDraft: "保存草稿",
    ...
    createResource: "创建",
    testTool: "测试调用",
    toolTestTitle: (name: string) => `测试工具 · ${name}`,
