package com.intra.copilot.interfaces.rest.identity;

import com.fasterxml.jackson.databind.JsonNode;
import com.intra.copilot.application.identity.AdminAuthService;
import com.intra.copilot.application.identity.AuthRateLimitService;
import com.intra.copilot.application.identity.DeviceRegistrationService;
...
public class AuthController {
    ...
    public record DeviceChallengeRequest(
            String deviceId, @NotNull JsonNode publicKeyJwk, @NotBlank String source) {}
    ...
    public DeviceRegistrationService.Challenge challenge(
            @Valid @RequestBody DeviceChallengeRequest request, HttpServletRequest servletRequest) {
    ...
    public DeviceRegistrationService.RegisteredDevice register(
            @Valid @RequestBody DeviceRegisterRequest request, HttpServletRequest servletRequest) {
        if (request == null) throw new IllegalArgumentException("设备注册请求不能为空");
        requireRateLimit(
