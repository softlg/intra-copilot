...
public class AgentAdminController {
        ...
        public List<com.intra.copilot.domain.agent.AgentConfigVersion> versions(@PathVariable String id) {
                return configurations.versions(id);
        }

        @PostMapping("/{id}/publish")
        public com.intra.copilot.domain.agent.AgentConfigVersion publish(
        ...
        public List<com.intra.copilot.domain.agent.AgentChildBinding> children(@PathVariable String id) {
                return configurations.children(id);
        }

        @PutMapping("/{id}/children")
        public List<com.intra.copilot.domain.agent.AgentChildBinding> children(
                        @PathVariable String id,
                        @RequestBody List<com.intra.copilot.domain.agent.AgentChildBinding> bindings) {
